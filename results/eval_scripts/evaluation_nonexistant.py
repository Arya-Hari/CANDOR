"""
Usage:
    python evaluate_nonexistant.py \\
        --input  raw_counterfactual_DeepSeek-v3.2.jsonl \\
        --output evaluated_counterfactual_DeepSeek-v3.2.jsonl

    python evaluate_nonexistant.py --input raw.jsonl --output out.jsonl --limit 10
...
# ── Prompt ────────────────────────────────────────────────────────────────────
SYSTEM_PROMPT = """You are evaluating LLM responses to non-existant questions — questions based on a premise that never happened or a fact that does not exist.
