...
results_dir = Path("../evaluation_results/counterfactual")
output_csv = Path("../metrics/counterfactual_cumulative_metrics.csv")
...
print(f"Counterfactual metrics successfully written to => {output_csv.absolute()}")